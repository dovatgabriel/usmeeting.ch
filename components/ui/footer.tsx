    ...
    <footer className="border-t transition-all">
      <div className="px-8 py-14 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <a
                  href="mailto:u.s.meetingoron@gmail.com"
                  className="hover:text-foreground transition-colors"
                >
                  u.s.meetingoron@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-6 border-t flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://www.facebook.com/u.s.meetingoron"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="size-8 rounded-full bg-linear-to-br from-purple-500 to-orange-500 flex items-center justify-center hover:opacity-80 transition-opacity"
            >
              <svg
            ...
            <a
              href="https://www.instagram.com/u.s.meetingoron/"
              target="_blank"
              rel="noopener noreferrer"
